/*
  ...
  timers.c - driver code for STM32H7xx ARM processors
...
static dtimer_t timers[] = {
...
#ifdef TIM15
    {
        .timer = TIM15,
        .irq = TIM15_IRQn,
        .resolution = IS_TIM_32B_COUNTER_INSTANCE(TIM15) ? Timer_32bit : Timer_16bit,
        .cap = {
          .comp1 = IS_TIM_CC1_INSTANCE(TIM15),
          .comp2 = IS_TIM_CC2_INSTANCE(TIM15)
        }
    },
#endif
#ifdef TIM17
    {
        .timer = TIM17,
        .irq = TIM17_IRQn,
        .resolution = IS_TIM_32B_COUNTER_INSTANCE(TIM17) ? Timer_32bit : Timer_16bit,
        .cap = {
          .comp1 = IS_TIM_CC1_INSTANCE(TIM17),
          .comp2 = IS_TIM_CC2_INSTANCE(TIM17)
        }
    },
#endif
};
