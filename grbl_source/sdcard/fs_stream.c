...
__attribute__((section(".itcmram"))) static bool ISR_FUNC(drop_input_stream)(char c)
{
...
__attribute__((section(".itcmram"))) static void ISR_FUNC(onCycleStart)(void)
{
...
__attribute__((section(".itcmram"))) static bool ISR_FUNC(await_toolchange_ack)(char c)
{
    if(c == CMD_TOOL_ACK) {
