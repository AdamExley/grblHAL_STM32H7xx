...
#ifndef TRINAMIC_DRIVER_MASK
#define TRINAMIC_DRIVER_MASK AXES_BITMASK
#endif
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & X_AXIS_BIT)
#ifndef TMC_X_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & Y_AXIS_BIT)
#ifndef TMC_Y_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & Z_AXIS_BIT)
#ifndef TMC_Z_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & A_AXIS_BIT)
#ifndef TMC_A_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & B_AXIS_BIT)
#ifndef TMC_B_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & C_AXIS_BIT)
#ifndef TMC_C_ENABLE
...
#if TRINAMIC_MIXED_DRIVERS && !(TRINAMIC_DRIVER_MASK & U_AXIS_BIT)
#ifndef TMC_U_ENABLE
