...
__attribute__((section(".itcmram"))) void ISR_FUNC(enqueue_feed_override)(uint8_t cmd)
{
...
__attribute__((section(".itcmram"))) void ISR_FUNC(enqueue_spindle_override)(uint8_t cmd)
{
...
__attribute__((section(".itcmram"))) void ISR_FUNC(enqueue_coolant_override)(uint8_t cmd)
{
