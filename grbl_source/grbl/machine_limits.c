...
__attribute__((section(".itcmram"))) axes_signals_t ISR_FUNC(limit_signals_merge)(limit_signals_t signals)
{
...
__attribute__((section(".itcmram"))) static axes_signals_t ISR_FUNC(homing_signals_select)(home_signals_t signals, axes_signals_t auto_square, squaring_mode_t mode)
{
    axes_signals_t state;
...
// switch is bouncing.
__attribute__((section(".itcmram"))) void ISR_FUNC(limit_interrupt_handler)(limit_signals_t state) // DEFAULT: Limit pin change interrupt process.
{
