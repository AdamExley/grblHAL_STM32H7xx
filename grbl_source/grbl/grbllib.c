...
__attribute__((section(".itcmram"))) static home_signals_t ISR_FUNC(get_homing_status)(void)
{
    home_signals_t home;
...
__attribute__((section(".itcmram"))) static home_signals_t ISR_FUNC(get_homing_status2)(void)
{
    home_signals_t home;
...
__attribute__((section(".itcmram"))) bool ISR_FUNC(task_add_delayed)(foreground_task_ptr fn, void *data, uint32_t delay_ms)
{
    core_task_t *task = NULL;
...
__attribute__((section(".itcmram"))) void task_delete (foreground_task_ptr fn, void *data)
{
...
__attribute__((section(".itcmram"))) bool ISR_FUNC(task_add_systick)(foreground_task_ptr fn, void *data)
{
    core_task_t *task = NULL;
...
*/
__attribute__((section(".itcmram"))) bool ISR_FUNC(task_add_immediate)(foreground_task_ptr fn, void *data)
{
    core_task_t *task = NULL;
...
\returns true if successful, false otherwise.
*/
__attribute__((section(".itcmram"))) bool ISR_FUNC(task_run_on_startup)(foreground_task_ptr fn, void *data)
{
    if(sys.cold_start) {
