...
// #ifdef GRBL_ESP32
// #include "esp_attr.h"
// #define __attribute__((section(".itcmram"))) IRAM_ATTR
// #elif !defined(__attribute__((section(".itcmram"))))
// // #define __attribute__((section(".itcmram"))) __attribute__((long_call, section(".data")))
// // Used to decorate code run in interrupt context.
// // Do not remove or change unless you know what you are doing.
// #define __attribute__((section(".itcmram"))) //!< Used by some drivers to force a function to always stay in RAM to improve performance.
// #endif
