...
__attribute__((section(".itcmram"))) static void ISR_FUNC(trap_control_cycle_start)(control_signals_t signals)
{
    spin_lock++;
...
__attribute__((section(".itcmram"))) static bool ISR_FUNC(trap_stream_cycle_start)(uint8_t c)
{
    bool drop = false;
...
__attribute__((section(".itcmram"))) static void ISR_FUNC(on_toolchange_ack)(void)
{
