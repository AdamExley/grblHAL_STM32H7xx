...
*/
__attribute__((section(".itcmram"))) void ISR_FUNC(control_interrupt_handler)(control_signals_t signals)
{
 ...
 */
__attribute__((section(".itcmram"))) void system_add_rt_report (report_tracking_t report)
{
    switch(report) {
