...
// Stepper shutdown
__attribute__((section(".itcmram"))) void ISR_FUNC(st_go_idle)(void)
{
...
__attribute__((section(".itcmram"))) static void st_spindle_sync_out (stepper_t *stepper)
{
...
__attribute__((section(".itcmram"))) void ISR_FUNC(stepper_driver_interrupt_handler)(void)
{
