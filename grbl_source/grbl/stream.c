...
__attribute__((section(".itcmram"))) static bool ISR_FUNC(await_toolchange_ack)(uint8_t c)
{
...
__attribute__((section(".itcmram"))) bool ISR_FUNC(stream_buffer_all)(uint8_t c)
{
    return false;
}

__attribute__((section(".itcmram"))) bool ISR_FUNC(stream_enqueue_realtime_command)(uint8_t c)
{
...
__attribute__((section(".itcmram"))) bool ISR_FUNC(stream_mpg_check_enable)(char c)
{
